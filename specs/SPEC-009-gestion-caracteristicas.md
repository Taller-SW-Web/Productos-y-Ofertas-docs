...
## 1. Contexto
Los productos requieren atributos como color, talla o material (características) y su clasificación por marcas. Este documento es dueño únicamente de las características y sus valores. La Asociación Categoría–Característica y Marcas se especifican por separado, evitando reglas normativas duplicadas.
...
Fuera de alcance normativo: `SPEC-011-gestion-marcas.md` y `SPEC-010-asociacion-categoria-caracteristica.md` son las únicas fuentes de sus respectivas reglas.
...
Las reglas de asociación, herencia y máximo 20 características efectivas se rigen exclusivamente por `SPEC-010-asociacion-categoria-caracteristica.md`; las reglas y unicidad de Marcas, por `SPEC-011-gestion-marcas.md`.
