...
# 1. ¿Es necesario compartir schemas entre microservicios?
...
## 1.2 La necesidad de datos externos no implica schema compartido
...
## 1.3 Qué sí comparte schema porque pertenece al mismo microservicio
